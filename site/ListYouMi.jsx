...
var ListYouMi = React.createClass({
    ...
    upData:function(idx){
        ...
        $.get('/merchant/Ad/list',postData,function(data){
	        ...
	        return (
	        	<div className="hb-box-wrap">
                    <div className="pb20 pt20 mb15 ubb1 fuzzy-border">
                         ...
                         <a href="/index.php?m=Merchant&a=add_ad&type=AddFormBox#/step1" className="btn fr base-btn">添加广告</a>
                    </div>
                    <div className="pb10">
                    ...
                    {this.state.rendData.map(function (obj,i) {
                        return (
                        <div key={i} className="hb-item ubb1 fuzzy-border mb15 pb20">
                            <div className="clearfix ">
                                ...
                                <div className="hb-left-img fl">
                                    <a href={"/index.php?m=Merchant&a=add_ad&type=AddFormBox#/step2/"+obj.id}><img src={obj.image} alt="" /></a>
                                </div>
                                <div className="fl w630 mt30 ml30">
                                    <a href={"/index.php?m=Merchant&a=add_ad&type=AddFormBox#/step2/"+obj.id} className="hb-item-tit fs24 mb10">{obj.title}</a>
                                    <p className="hb-item-info desalt-color mt5 mb15">广告简介：{obj.description}</p>
                                    <div className="hb-item-bottom mb15">
                                        <div className="pl5 pr5 br5 base-bg vm white-color inline-block">{obj.type_name}</div>
                                        <div className="inline-block ml10 mr10 vm" onClick={this.turnShow.bind(this,obj.id,obj.status)}><Switchery show={obj.status==1?true:false}/></div>
